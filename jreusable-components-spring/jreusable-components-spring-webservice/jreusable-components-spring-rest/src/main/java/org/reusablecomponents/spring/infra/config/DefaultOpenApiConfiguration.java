package org.reusablecomponents.spring.infra.config;
...
//	    schemas.put(mySchema.getName(), mySchema);
    ...
    private void createResponse(final Operation operation) {
...
//	}
	...
	return (operation, handleMethod) -> {
	    ...
	    final var classEntity = getClassRequestMapping(method, RequestMapping.class);
		...
		final var methodEntity = getMethodRequestMapping(method, DeleteMapping.class);
    ...
    private String getClassRequestMapping(final Method method, final Class<? extends Annotation> classAnnotationClazz) {
    ...
    private String getMethodRequestMapping(final Method method, final Class<? extends Annotation> methodAnnotationClazz) {
