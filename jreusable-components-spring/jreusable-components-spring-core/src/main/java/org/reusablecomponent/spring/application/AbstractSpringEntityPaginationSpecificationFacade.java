...
import org.reusablecomponent.application.EntityPaginationSpecificationFacade;
...
import org.reusablecomponent.spring.domain.InterfaceSpringPaginationRepository;
...
public abstract class AbstractSpringEntityPaginationSpecificationFacade <Entity extends AbstractEntity<Id>, Id, Specification> 
    ...
    protected SpringI18nFunction i18n;
     ...
     * @param i18n
     */
    protected AbstractSpringEntityPaginationSpecificationFacade(final InterfaceSpringPaginationRepository<Entity, Id> repository, final SpringI18nFunction i18n) {
	super(
