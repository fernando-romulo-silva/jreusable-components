...
public class RestExceptionHandler extends AbstractRestExceptionHandler {
    ...
    ResponseEntity<Object> handleElementElementConflictException(final ElementConflictException ex,
    ...
    ResponseEntity<Object> handleServiceUnavailableException(final ServiceUnavailableException ex,
            final WebRequest request) {
        return handleObjectException(ex, request, HttpStatus.SERVICE_UNAVAILABLE);
    }

    @ExceptionHandler(BaseException.class)
    ResponseEntity<Object> handleBaseApplicationException(final BaseException ex, final WebRequest request) {
