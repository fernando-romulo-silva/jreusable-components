 ...
 * @param <Id>
 */
public interface InterfaceSpringEntityQueryHttpController<Entity extends InterfaceEntity<Id>, Id>
                extends
                InterfaceEntityQueryHttpController<Id, ResponseEntity<Void>, ResponseEntity<Entity>, ResponseEntity<Iterable<Entity>>> {
        ...
        ResponseEntity<Entity> get(@PathVariable final Id id, final HttpServletRequest request,
        ...
        ResponseEntity<Void> head(@PathVariable final Id id, final HttpServletRequest request,
                        final HttpServletResponse response);
