...
abstract class AbstractRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Handle exceptions, especially {@link BaseException} and its descendents and
	 ...
	 */
	protected ResponseEntity<Object> handleObjectException(final Throwable ex, final WebRequest request,
			final HttpStatus status) {

		final var msg = ex instanceof BaseException ? escapeJava(getMessage(ex)) : escapeJava(getRootCauseMessage(ex));
	 ...
	 * @return A {@link ResponseEntity} object that's the response
	 */
	protected ResponseEntity<Object> handleObjectException(final String msg,
			final Collection<Map<String, String>> subErrors, final Throwable ex, final WebRequest request,
			final HttpStatusCode status) {
	...
	private Map<String, Object> buildResponseBody(final String message, final Collection<Map<String, String>> subErrors,
			final HttpStatusCode statusCode, final Throwable ex, final WebRequest request) {
