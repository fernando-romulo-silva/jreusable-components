...
public class ElementAlreadyExistsException extends ElementConflictException {
     ...
     * Constructs a new ElementAlreadyExistsException exception and create detail
     * message regard of parameters. </br>
     * The exception detail msg will be: cls.getSimpleName() + " with " + msg + "
     * already exists". </br>
    ...
    public <T> ElementAlreadyExistsException(final Class<T> cls, final Object... params) {
        super("{exception.elementFieldsAlreadyExists}",
                ArrayUtils.addAll(new Object[] { cls.getSimpleName() }, params));
    }
     ...
     * @param msg  The specific message
     */
    public <T> ElementAlreadyExistsException(final Class<T> cls, final InterfaceI18nService i18n,
            final Object[] params) {
        super("{exception.elementFieldsAlreadyExists}", i18n,
                ArrayUtils.addAll(new Object[] { cls.getSimpleName() }, params));
    }
}
