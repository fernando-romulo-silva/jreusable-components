...

{
    ...
    protected final InterfaceCommandFacade entityCommandFacade;
    // <Entity, Id, OneResult, MultipleResult, VoidResult, WrapEntity, WrapEntities,
    // WrapIds>

    // protected final Function<Id, Optional<Entity>> findByIdFunction;

    public DtoCommandFacade(
            @NotNull final InterfaceCommandFacade entityCommandFacade) {
        super();
    ...
    // entityCommandFacade.saveAll((MultipleResult)entities);
    ...
    // @NotNull final BiFunction<@NotNull DTO, @NotNull Entity, @NotNull Entity>
    // updateEntityData,
    // @NotNull final Function<@NotNull Entity, @NotNull DTO> convertToDto) {
    //
    // final var entity = findByIdFunction.apply(id)
    // .orElseThrow(() -> new ElementWithIdNotFoundException(getEntityClazz(),
    // getI18nService(), id));
    //
    // final var entityToUpdate = updateEntityData.apply(dto, entity);
    //
    // // TODO how about Mono<Entity>?
    //// final var entityUpdated = (Entity)
    // entityCommandFacade.update(entityToUpdate);
    //
    ...
    // throw new ElementWithIdNotFoundException(getEntityClazz(), getI18nService(),
    // id);
    // }
    //
    ...
    // .toList();
    //
    //// final var entitiesUpdated = entityCommandFacade.updateAll((MultipleResult)
    // entitiesToUpdate);
    //
    // return null;
    // }
