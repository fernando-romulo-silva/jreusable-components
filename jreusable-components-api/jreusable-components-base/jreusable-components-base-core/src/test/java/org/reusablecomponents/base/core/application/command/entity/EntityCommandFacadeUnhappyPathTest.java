...
class EntityCommandFacadeUnhappyPathTest {
    ...
    Stream<Arguments> createInvalidUpdateAllData() {
        ...
        return Stream.of(
                Arguments.of(nullList, NullPointerException.class, "The object '%s' cannot be null", nullListParams),

                Arguments.of(List.of(unknownDepartment, correctDepartment),
                        ElementNotFoundException.class,
                        "The object '[%s", elementAlreadyExistsParams),

                Arguments.of(List.of(invalidDepartment, correctDepartment), ElementInvalidException.class,
                        "The object '[%s", elementAlreadyExistsParams));
    }
    ...
    Stream<Arguments> createInvalidDeleteAllByIdData() {
        ...
        final var elementHasConflictParams = List.of(conflictDepartment.getId() + ", " + correctDepartment.getId());

        final var elementInvalidParams = List.of(invalidDepartment.getId() + ", " + correctDepartment.getId());

        return Stream.of(
                Arguments.of(nullList, NullPointerException.class, "The object '%s' cannot be null", nullPointerParams),
