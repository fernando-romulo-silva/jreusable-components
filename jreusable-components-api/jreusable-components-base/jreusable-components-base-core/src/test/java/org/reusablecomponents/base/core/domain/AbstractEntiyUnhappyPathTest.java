...
class AbstractEntiyUnhappyPathTest extends AbstractValidatorTest {
	...
	void createEntityWithBuilderTest(final Long id, final String name, final String createdReason, final Integer score,
			final Gender gender, final String country, final LocalDate birthDate, final List<Hobby> hobbies) {
