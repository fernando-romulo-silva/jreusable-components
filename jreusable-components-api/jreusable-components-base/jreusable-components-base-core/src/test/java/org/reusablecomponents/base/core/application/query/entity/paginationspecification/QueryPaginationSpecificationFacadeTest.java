...
class QueryPaginationSpecificationFacadeTest {
    ...
    @Test
    @Order(1)
    @DisplayName("given spec and sort when findOneByPaginationSorted then return result")
    void given_spec_and_sort_when_findOneByPaginationSorted_then_return_result() {
        // given
        ...
        // when
        final var result = assertDoesNotThrow(() -> defaultQueryFacade.findOneByPaginationSorted(spec, sort));
    ...
    @Test
    @Order(2)
    @DisplayName("given spec and pageable when findByPaginationPaged then return result")
    void given_spec_and_pageable_when_findByPaginationPaged_then_return_result() {
        // given
    ...
    @DisplayName("given invalid params when findOneByPaginationSorted then throw exception")
    void given_invalid_params_when_findOneByPaginationSorted_then_throw_exception(
    ...
    @ParameterizedTest(name = "Pos {index} : sort ''{0}'', specification ''{1}''")
    @MethodSource("findOneByWithNullParamsData")
    @DisplayName("given invalid params when findOneByPaginationSorted then throw exception - bean validation")
    void given_invalid_params_when_findOneByPaginationSorted_then_throw_exception_bean_validation(
            final Comparator<Department> sort,
    ...
    @DisplayName("given invalid params when findByPaginationPaged then throw exception")
    void given_invalid_params_when_findByPaginationPaged_then_throw_exception(
    ...
    @ParameterizedTest(name = "Pos {index} : pageable ''{0}'', specification ''{1}''")
    @MethodSource("findByWithNullParamsData")
    @DisplayName("given invalid params when findByPaginationPaged then throw exception - bean validation")
    void given_invalid_params_when_findByPaginationPaged_then_throw_exception_bean_validation(
            final PageList<Department> pageable,
            final Predicate<Department> specification) throws NoSuchMethodException, SecurityException {
