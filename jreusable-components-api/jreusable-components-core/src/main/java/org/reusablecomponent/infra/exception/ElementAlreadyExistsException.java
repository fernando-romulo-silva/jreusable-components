...
public class ElementAlreadyExistsException extends ElementConflictException {
     ...
     * @param id  Object id that repeated
     */
    public <T> ElementAlreadyExistsException(final Class<T> cls, final I18nFuntion i18n, final Object id) {
     ...
     * @param msg The specific message
     */
    public <T> ElementAlreadyExistsException(final Class<T> cls, final I18nFuntion i18n, final Object[] params) {
