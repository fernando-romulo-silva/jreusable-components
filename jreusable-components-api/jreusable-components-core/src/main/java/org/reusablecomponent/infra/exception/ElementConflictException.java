...
public class ElementConflictException extends BaseApplicationException {
     ...
     * @param params The parameters used on message
     */
    public ElementConflictException(final String msg, final I18nFuntion i18n, final Object... params) {
     ...
     * @param params The parameters used on message
     */
    public ElementConflictException(final String msg, final I18nFuntion i18n, final Throwable ex, final Object... params) {
