...
import org.reusablecomponent.application.query.entity.nonpaged.EntityQueryFacade;
 ...
 * @param <Specification>
 */
public class EntityFacade <Entity extends AbstractEntity<Id>, Id, OneResultCommand, OneResultQuery, MultipleResult, CountResult, ExistsResult, VoidResult>
        //
