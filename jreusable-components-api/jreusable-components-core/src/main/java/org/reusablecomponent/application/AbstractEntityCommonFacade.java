 ...
 * @param <ExistsResult>
 */
abstract class AbstractEntityCommonFacade <Entity extends AbstractEntity<Id>, Id, OneResult, MultipleResult, VoidResult, ExistsResult>
     ...
     */
    protected AbstractEntityCommonFacade(@NotNull final InterfaceEntityCommandFacade<Entity, Id, OneResult, MultipleResult, VoidResult> entityCommandFacade) {
	super();
