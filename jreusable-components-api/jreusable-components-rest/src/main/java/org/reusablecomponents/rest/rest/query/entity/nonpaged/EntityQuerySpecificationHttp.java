 ...
 * @param <Specification>
 */
public class EntityQuerySpecificationHttp<Entity extends InterfaceEntity<Id>, Id, QueryIdIn,
		// results
		...
		implements
		InterfaceEntityQuerySpecificationHttp<QueryIdIn, HttpResponseVoid, HttpResponseOne, HttpResponseMultiple, Specification> {
	...
	protected EntityQuerySpecificationHttp(
			final EntityQuerySpecificationHttpBuilder<Entity, Id, QueryIdIn, OneResult, MultipleResult, CountResult, ExistsResult, Specification, HttpResponseVoid, HttpResponseOne, HttpResponseMultiple> builder) {
	 ...
	 */
	@Override
	public HttpResponseMultiple getBy(final Specification specification, final HttpServletRequest request,
