...
public class EntityCommandHttpController<Entity extends AbstractEntity<Id>, Id, // basic
	 ...
	 */
	@Override
	public HttpResponse post(final SaveEntityIn saveEntityIn, final HttpServletRequest request,
	 ...
	 */
	@Override
	public HttpResponse delete(final DeleteIdIn deleteIdIn, final HttpServletRequest request,
			final HttpServletResponse response) {
	 ...
	 */
	@Override
	public HttpResponse put(final QueryIdIn id, final UpdateEntityIn updateEntityIn, final HttpServletRequest request,
			final HttpServletResponse response) {
	 ...
	 * @return
	 */
	// protected final UpdateEntityIn applyPatchToJObject(final List<JsonPatch>
	// jsonPatchs, final OneResult targetObject) {
	//
